...
import { LuBedDouble, LuCalendarClock, LuLayoutGrid, LuListChecks, LuUsers } from 'react-icons/lu';
...
const ITEMS = [
  ...
  { id: 'camas', label: 'Camas', href: '/gestion-enfermeria/camas', icon: LuBedDouble },
...
// Navegación entre las 5 secciones de nivel superior de Gestión de
...
// volver a Panel General desde las otras pantallas. Se monta igual en las 5
// rutas (Panel general/Pacientes/Camas/Turnos/Tareas); el activo se deriva de
// usePathname() en vez de un prop, mismo criterio que Sidebar.jsx (ver
