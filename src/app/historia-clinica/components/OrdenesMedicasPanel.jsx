    ...
    <div role="tabpanel" id="panel-ordenes" aria-labelledby="tab-ordenes" tabIndex="0" className="tab-panel">
      <div className="subnav-bar" role="tablist" aria-label="Tipo de orden">
        <button type="button" className="subnav-tab active" role="tab" id="subtab-ome-medicamentos" aria-selected="true" aria-controls="subpanel-ome-medicamentos" tabIndex="0">
          <svg className="icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10.5 20H4a2 2 0 0 1-2-2V5c0-1.1.9-2 2-2h3.9c.5 0 .9.2 1.3.5l.8.8c.4.3.8.5 1.3.5H20a2 2 0 0 1 2 2v3"/><path d="m16 19 2 2 4-4"/></svg>
          Medicamentos
        </button>
